    ...
    <div class="max-w-4xl mx-auto pb-12">
      ...
      <header class="mb-10 border-b border-border pb-10">
        ...
        <p class="mt-4 text-lg text-muted-foreground max-w-2xl leading-relaxed">
          A standalone, tree-shakable SVG icon library. Register only the icons you need for optimized bundles, or use
      ...
      <!-- All Icons Grid -->
      <section class="mb-12">
        <h2 class="text-xl font-semibold tracking-tight text-foreground mb-5">All Icons</h2>
      ...
      <!-- Colors via CSS -->
      <section class="mb-12">
        <h2 class="text-xl font-semibold tracking-tight text-foreground mb-5">Color Inheritance</h2>
        <div class="rounded-xl border border-border bg-card overflow-hidden shadow-sm">
          <div class="p-8 flex items-center justify-center gap-6">
            ...
            <and-icon name="info" size="28" class="text-muted-foreground"></and-icon>
          </div>
          <div class="border-t border-border bg-muted/30 px-5 py-3">
            <p class="text-xs text-muted-foreground m-0">
              Icons inherit <code class="text-xs">color</code> from their parent via
              <code class="text-xs">currentColor</code>. Apply any text color utility to tint them.
            </p>
          </div>
        </div>
      </section>
