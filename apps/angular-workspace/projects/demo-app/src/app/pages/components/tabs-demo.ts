    ...
    <div class="max-w-4xl mx-auto pb-12">
      ...
      <header class="mb-10 border-b border-border pb-10">
        ...
        <p class="mt-4 text-lg text-muted-foreground max-w-2xl leading-relaxed">
          Organize content into separate views that can be toggled within the same context. Only one tab panel is
          visible at a time.
        </p>
      </header>
            ...
            <div class="max-w-xl mx-auto">
              <and-tabs value="account">
                <and-tabs-list>
                  ...
                  <and-tabs-trigger value="notifications">Notifications</and-tabs-trigger>
                </and-tabs-list>
                <and-tabs-content value="account">
                  <div class="py-4">
                    <h3 class="text-base font-semibold text-foreground mb-2 mt-0">Account Settings</h3>
                    <p class="text-sm text-muted-foreground leading-relaxed m-0">
                      Manage your account details, display name, and preferences. Changes will be reflected across all
                      your sessions.
                    </p>
                  </div>
                </and-tabs-content>
                <and-tabs-content value="password">
                  <div class="py-4">
                    <h3 class="text-base font-semibold text-foreground mb-2 mt-0">Password</h3>
                    <p class="text-sm text-muted-foreground leading-relaxed m-0">
                      Update your password regularly to keep your account secure. We recommend using a strong, unique
                      password.
                    </p>
                  </div>
                </and-tabs-content>
                <and-tabs-content value="notifications">
                  <div class="py-4">
                    <h3 class="text-base font-semibold text-foreground mb-2 mt-0">Notifications</h3>
                    <p class="text-sm text-muted-foreground leading-relaxed m-0">
                      Configure how and when you receive notifications. Fine-tune email, push, and in-app notification
                      preferences.
                    </p>
                  </div>
                </and-tabs-content>
      ...
      <section class="mb-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div class="rounded-xl border border-border bg-card p-5">
            <h3 class="text-sm font-semibold text-foreground mb-2">Keyboard Nav</h3>
            <p class="text-sm text-muted-foreground m-0 leading-relaxed">
              Arrow keys to switch tabs, Home/End for first/last.
            </p>
          </div>
          <div class="rounded-xl border border-border bg-card p-5">
            <h3 class="text-sm font-semibold text-foreground mb-2">Accessible</h3>
            <p class="text-sm text-muted-foreground m-0 leading-relaxed">
              Proper tablist/tab/tabpanel ARIA roles and states.
            </p>
          </div>
          <div class="rounded-xl border border-border bg-card p-5">
            <h3 class="text-sm font-semibold text-foreground mb-2">Controlled</h3>
            <p class="text-sm text-muted-foreground m-0 leading-relaxed">
