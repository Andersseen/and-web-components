    ...
    <div class="max-w-4xl mx-auto pb-12">
      ...
      <section class="mb-12">
        ...
        <p class="text-sm text-muted-foreground mb-5 max-w-2xl leading-relaxed">
          The prompt character is hidden by default — opt in with
          <code class="text-xs bg-muted px-1.5 py-0.5 rounded">show-prompt</code>, then customize the character with
          <code class="text-xs bg-muted px-1.5 py-0.5 rounded">prompt</code>. It's just a display hint —
          <code class="text-xs bg-muted px-1.5 py-0.5 rounded">and-code</code> doesn't do syntax highlighting or know
          about npm vs. pnpm.
        </p>
        <div class="rounded-xl border border-border bg-card overflow-hidden shadow-sm">
          <div class="p-8 flex flex-col gap-4 max-w-2xl mx-auto">
            ...
            <and-code show-prompt="true" value="pnpm build:all"></and-code>
            <and-code show-prompt="true" prompt=">" value="npm install @andersseen/web-components"></and-code>
          </div>
        </div>
      </section>
...
export default class CodeDemo {
  ...
  templateCode = `<!-- No prompt (default) -->
<and-code value="git commit -m 'feat: add code component'"></and-code>

<!-- Opt in to the $ prompt -->
<and-code show-prompt="true" value="pnpm build:all"></and-code>
