...
@Component({
  ...
  imports: [AndInput, DemoCodeBlockComponent],
  template: `
    <div class="max-w-4xl mx-auto pb-12">
      ...
      <header class="mb-10 border-b border-border pb-10">
        ...
        <p class="mt-4 text-lg text-muted-foreground max-w-2xl leading-relaxed">
          Form input fields for collecting user data. Supports multiple types, placeholder text, and disabled states.
        </p>
      </header>
          ...
          <div class="p-8">
            <div class="max-w-md mx-auto flex flex-col gap-5">
              ...
              <div class="flex flex-col gap-2">
                ...
                <and-input placeholder="you@example.com" type="email"></and-input>
              </div>
              <div class="flex flex-col gap-2">
                <label class="text-sm font-medium text-foreground">Password</label>
                <and-input placeholder="Enter password" type="password"></and-input>
              </div>
              <div class="flex flex-col gap-2">
      ...
      <!-- Form Example -->
      <section class="mb-12">
        <h2 class="text-xl font-semibold tracking-tight text-foreground mb-5">Form Example</h2>
        <div class="rounded-xl border border-border bg-card overflow-hidden shadow-sm">
          <div class="p-8">
            <div class="max-w-md mx-auto flex flex-col gap-5">
              ...
              <div class="flex flex-col gap-2">
                <label class="text-sm font-medium text-foreground">Company Email</label>
                <and-input placeholder="john@company.com" type="email"></and-input>
                <span class="text-xs text-muted-foreground">We'll use this for account recovery.</span>
              </div>
            </div>
          </div>
        </div>
...
export default class InputDemo {
  templateCode = `<and-input placeholder="Default Input" type="text"></and-input>
<and-input placeholder="Email" type="email"></and-input>
<and-input placeholder="Password" type="password"></and-input>
<and-input placeholder="Disabled" disabled="true"></and-input>`;
}
