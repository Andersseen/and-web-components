    ...
    <div class="max-w-4xl mx-auto pb-12">
      ...
      <header class="mb-10 border-b border-border pb-10">
        ...
        <p class="mt-4 text-lg text-muted-foreground max-w-2xl leading-relaxed">
          Collapsible content panels for organizing and revealing information progressively. Built on the headless core
              ...
              <and-accordion [allowMultiple]="allowMultiple()" [disabled]="disabled()">
                <and-accordion-item value="item-1">
                  ...
                  <and-accordion-content>
                    Stencil is a compiler that generates Web Components (specifically, Custom Elements). It combines the
                    best concepts of the most popular frameworks into a simple build-time tool.
                  </and-accordion-content>
                </and-accordion-item>
                <and-accordion-item value="item-2">
                  ...
                  <and-accordion-content>
                    ...
                    encapsulated HTML tags for use in web pages and web apps. They work across frameworks.
                  </and-accordion-content>
                </and-accordion-item>
                <and-accordion-item value="item-3">
                  <and-accordion-trigger>How does it integrate with Angular?</and-accordion-trigger>
                  <and-accordion-content>
                    Stencil generates Angular-specific wrappers that provide type-safe bindings, proper event handling,
                    and seamless integration with Angular's change detection.
                  </and-accordion-content>
                </and-accordion-item>
              </and-accordion>
            </div>
      ...
      <section>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div class="rounded-xl border border-border bg-card p-5">
            <h3 class="text-sm font-semibold text-foreground mb-2">Multi-expand</h3>
