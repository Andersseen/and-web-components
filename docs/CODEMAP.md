...
| Change **Angular wrappers**                                                         | Regenerate by building Stencil (`pnpm build:stencil`)                                                                                                              | `apps/angular-workspace/projects/angular-components/src/lib/stencil-generated/**` (generated) |
...
| `@andersseen/angular-components`  | `apps/angular-workspace/projects/angular-components` | Generated Angular lib | `pnpm build:angular`                     |
