 ...
 */
export type MotionAnimation = "motion-fade-in" | "motion-fade-out" | "motion-scale-in" | "motion-scale-out" | "motion-bounce-in" | "motion-rotate-in" | "motion-slide-in-top" | "motion-slide-in-bottom" | "motion-slide-in-left" | "motion-slide-in-right" | "motion-slide-out-top" | "motion-slide-out-bottom" | "motion-slide-out-left" | "motion-slide-out-right" | string;
