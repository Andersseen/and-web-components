...
const contentBaseClass = ['mt-2', 'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring'].join(' ');
  ...
  render() {
    return (
      <Host
        ...
        class={cn(contentBaseClass, 'and-tab-content', this.selected ? 'block' : 'hidden')}
