...
import { sidebarVariants, sidebarItemVariants, type SidebarVariantProps } from './and-sidebar-variants';
...
/**
 * Collapsible vertical navigation sidebar (`<aside>`), with `main` and
 * `bottom` item sections and a built-in collapse toggle.
 *
 * @example
 * ```html
 * <and-sidebar items='[{"id":"home","label":"Home","icon":"home"}]' active-item="home">
 * </and-sidebar>
 * ```
 */
@Component({
