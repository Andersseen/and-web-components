...
| `name`        | `name`         | The name of the icon to render                | `"accessibility" \| "activity" \| "arrow-down" \| "arrow-left" \| "arrow-right" \| "arrow-up" \| "bell" \| "box" \| "chevron-down" \| "chevron-left" \| "chevron-right" \| "chevron-up" \| "close" \| "error" \| "eye" \| "eye-off" \| "file-text" \| "home" \| "image" \| "info" \| "layers" \| "layout" \| "list-ordered" \| "loader" \| "lock" \| "maximize" \| "menu" \| "message-square" \| "minimize" \| "moon" \| "play" \| "rotate-ccw" \| "rotate-cw" \| "settings" \| "star" \| "sun" \| "toggle-left" \| "user"` | `undefined`      |
