...
| `name`        | `name`         | The name of the icon to render                | `"arrow-up" \| "bell" \| "box" \| "chevron-down" \| "chevron-left" \| "chevron-right" \| "close" \| "error" \| "file-text" \| "home" \| "image" \| "info" \| "layers" \| "layout" \| "list-ordered" \| "loader" \| "lock" \| "menu" \| "message-square" \| "settings" \| "star" \| "toggle-left" \| "user"` | `undefined`      |
