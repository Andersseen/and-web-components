...
describe('createNavbar', () => {
  ...
  it('provides correct item props', () => {
    const navbar = createNavbar({ items: mockItems, defaultActiveItem: 'home' });
    ...
    const optionsProps = navbar.getItemProps('home', { href: '/', target: '_blank' });
  ...
  it('handles keyboard navigation correctly', () => {
    ...
    navbar.handleItemKeyDown({ key: 'ArrowRight', preventDefault } as any, 'home');
    ...
    navbar.handleItemKeyDown({ key: 'ArrowLeft', preventDefault } as any, 'about');
    expect(navbar.state.activeItem).toBe('home');

    // ArrowLeft from 'home' -> 'about' (wraps around, skipping disabled 'contact')
    navbar.handleItemKeyDown({ key: 'ArrowLeft', preventDefault } as any, 'home');
    expect(navbar.state.activeItem).toBe('about');

    // ArrowRight from 'about' -> 'home' (wraps around, skipping disabled 'contact')
    navbar.handleItemKeyDown({ key: 'ArrowRight', preventDefault } as any, 'about');
    expect(navbar.state.activeItem).toBe('home');
